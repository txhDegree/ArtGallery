...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    <div class="row">
        ...
        <div class="col-12 my-2">
            <div class="alert alert-success">Your payment is completed, the Artists will prepare your order soon! <a class="btn btn-success" href="/Customer/Artworks/List.aspx">Back To Art Galleries</a></div>
        </div>
